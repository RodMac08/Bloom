<template>
  <div
    ...
    :class="['relative rounded-xl overflow-hidden p-8 shadow-xl', backgroundColor, className]"
  >
    <div
...
const { className = '', spotlightColor = 'rgba(255, 255, 255, 0.25)', backgroundColor = 'bg-blue-500' } = defineProps<SpotlightCardProps>();
